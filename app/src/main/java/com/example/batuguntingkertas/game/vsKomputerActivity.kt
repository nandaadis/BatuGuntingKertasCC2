...
import com.example.batuguntingkertas.databinding.RvMemoBinding.inflate
import java.util.*

class vsKomputerActivity : AppCompatActivity() {

    lateinit var binding: ActivityVsKomputerBinding
    var kamu:Int = 0
    var lawan:Int = 0

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_vs_komputer)
        binding = ActivityVsKomputerBinding.inflate(layoutInflater)
